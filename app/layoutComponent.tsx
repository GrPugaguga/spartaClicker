...
export default function LayoutComponent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-roman-black">
      <main>{children}</main>

      <div className="fixed bottom-0 left-0 right-0 flex justify-around p-4 bg-roman-wood">
  <button onClick={navigateToSwordPage} className="text-roman-gold hover:text-roman-red transition-colors">
  ...
  <button onClick={navigateToTreasurePage} className="text-roman-gold hover:text-roman-red transition-colors">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="48" height="48">
  ...
  <button onClick={navigateToHelmetPage} className="text-roman-gold hover:text-roman-red transition-colors">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="48" height="48">
